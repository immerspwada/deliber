...
const isActive = (path: string) => {
  ...
  if (path === '/provider/my-jobs') {
    return route.path === '/provider/my-jobs' || route.path === '/provider/history'
  }
      ...
      <div class="nav-container">
        ...
        >
          <div class="nav-icon-wrapper">
            ...
            <!-- Jobs Icon -->
            <svg v-else-if="item.icon === 'jobs'" class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- User Icon -->
            <svg v-else-if="item.icon === 'user'" class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
