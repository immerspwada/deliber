 ...
 * Component: DeliveryRatingModal
 * Tables: delivery_ratings
 */
import { ref, computed } from 'vue'
import { useServiceRatings, DELIVERY_TAGS } from '../../composables/useServiceRatings'
...
const { submitDeliveryRating, loading } = useServiceRatings()

const overallRating = ref(0)
const speedRating = ref(0)
const careRating = ref(0)
...
const handleSubmit = async () => {
  const result = await submitDeliveryRating({
    deliveryId: props.deliveryId,
    rating: overallRating.value,
    speedRating: speedRating.value || undefined,
    careRating: careRating.value || undefined,
...
<template>
  <div v-if="show" class="modal-overlay" @click.self="handleClose">
    <div class="rating-modal">
      ...
      <h3 class="rating-title">ให้คะแนนการส่งของ</h3>
      <p class="rating-subtitle">คุณพอใจกับบริการของ {{ riderName }} หรือไม่?</p>
      ...
      <div v-if="overallRating > 0" class="detail-ratings">
        ...
        <div class="detail-rating-item">
          <span class="detail-label">ดูแลพัสดุ</span>
          <div class="mini-stars">
            <button 
              v-for="star in 5" 
              :key="star"
      ...
      <div class="tip-section">
        <p class="tip-label">ให้ทิปไรเดอร์</p>
