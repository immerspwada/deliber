    ...
    <div class="login-container">
      ...
      <div v-if="loginMethod === 'otp'" class="form-section">
        <div v-if="!isOtpSent">
          ...
          <button :disabled="!isEmailValid || isLoading" class="btn-primary" @click="sendEmailOtp">
        ...
        <div v-else>
          ...
          <button :disabled="otp.length !== 6 || isLoading" class="btn-primary" @click="verifyEmailOtp">
            <span v-if="isLoading" class="loading"><span class="spinner"></span>ตรวจสอบ...</span>
            <span v-else>ยืนยัน OTP</span>
          </button>
          <div class="otp-links">
            <button class="link-btn" @click="resetOtpState">เปลี่ยนอีเมล</button>
            <button :disabled="isLoading" class="link-btn" @click="sendEmailOtp">ส่งอีกครั้ง</button>
          </div>
        </div>
      </div>
      ...
      <div v-else class="form-section">
        ...
        <button :disabled="!email || !password || isLoading" class="btn-primary" @click="loginWithPassword">
      ...
      <div class="social-section">
        ...
        <div class="social-buttons">
          <button :disabled="!!socialLoading" class="social-btn google" @click="loginWithGoogle">
          ...
          <button :disabled="!!socialLoading" class="social-btn facebook" @click="loginWithFacebook">
      ...
      <div class="register-row">
        ...
        <button class="link-btn accent" @click="goToRegister">สมัครสมาชิก</button>
      </div>
