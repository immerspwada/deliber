...
async function searchPlaces() {
  ...
  // Use Google Places API or local search
  // For now, filter from recent/saved places
        ...
        <div v-if="!searchQuery" class="quick-picks">
          ...
          <div v-if="savedPlaces?.length" class="picks-section">
            ...
            <div class="picks-grid">
              ...
              >
                <div class="pick-icon">
                  {{ place.place_type === 'home' ? '🏠' : place.place_type === 'work' ? '💼' : '📍' }}
                </div>
        ...
        <div class="confirm-section">
          ...
          <div class="route-card">
            <div class="route-point">
              ...
              <div class="point-info">
                ...
                <span class="point-address">{{ pickup?.address }}</span>
              </div>
            </div>
            ...
            <div class="route-point">
              ...
              <div class="point-info">
                ...
                <span class="point-address">{{ destination?.address }}</span>
              </div>
            </div>
          </div>
          ...
          <div class="vehicle-section">
            ...
            <div class="vehicle-list">
              <div 
                v-for="v in vehicles" 
                :key="v.id"
                :class="['vehicle-card', { selected: selectedVehicle === v.id }]"
                @click="selectedVehicle = v.id as any"
              >
                <div class="v-icon">{{ v.icon }}</div>
                <div class="v-info">
                  <div class="v-name">{{ v.name }}</div>
                  <div class="v-desc">{{ v.desc }} · {{ v.eta }}</div>
                </div>
          ...
          <div class="trip-info">
            ...
            <div class="info-item">
              ...
              <span class="info-value">{{ estimatedTime }} นาที</span>
            </div>
          </div>
        </div>
