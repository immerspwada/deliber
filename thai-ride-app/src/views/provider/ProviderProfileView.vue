        ...
        <div class="stats-row">
          ...
          <div class="stat-card">
            <span class="stat-value">{{
              profile?.is_verified ? "ยืนยันแล้ว" : "รอยืนยัน"
            }}</span>
          ...
          <div class="vehicle-info">
            <div class="vehicle-row">
              ...
              <span class="vehicle-value"
                >{{ (profile as any).vehicle_brand || "Toyota" }}
                {{ (profile as any).vehicle_model || "Vios" }}</span
              >
            </div>
            <div class="vehicle-row">
              <span class="vehicle-label">ประเภท</span>
              <span class="vehicle-value">{{
                profile.vehicle_type || "รถยนต์"
              }}</span>
            </div>
            <div class="vehicle-row">
              <span class="vehicle-label">ทะเบียน</span>
              <span class="vehicle-value">{{
                profile.vehicle_plate || "กข 1234 กรุงเทพ"
              }}</span>
            </div>
            <div class="vehicle-row">
              <span class="vehicle-label">สี</span>
              <span class="vehicle-value">{{
                profile.vehicle_color || "สีดำ"
              }}</span>
            </div>
