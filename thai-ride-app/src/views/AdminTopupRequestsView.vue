...
const loadData = async () => {
  loading.value = true;
  await Promise.all([fetchPendingTopups(), loadAllRequests(), loadStats()]);
  loading.value = false;
};
    ...
    <div class="admin-page">
      ...
      <div v-if="stats" class="stats-grid">
        ...
        <div class="stat-card">
          <span class="stat-value"
            >฿{{ (stats.pending_topup_amount || 0).toLocaleString() }}</span
          >
        ...
        <div class="stat-card">
          <span class="stat-value"
            >฿{{ (stats.today_topup_amount || 0).toLocaleString() }}</span
          >
      ...
      <div class="tabs-row">
        <div class="tabs">
          ...
          >
            รอดำเนินการ
            <span v-if="pendingTopups.length" class="badge">{{
      ...
      <div v-else-if="filteredRequests.length === 0" class="empty-state">
        ...
        <p>
          {{
            activeTab === "pending" ? "ไม่มีคำขอที่รอดำเนินการ" : "ไม่พบรายการ"
          }}
        </p>
      </div>
        ...
        <table>
          ...
          <tbody>
            <tr v-for="req in filteredRequests" :key="req.id">
              ...
              <td>
                <span
                  :class="['status-badge', formatTopupStatus(req.status).color]"
                >
