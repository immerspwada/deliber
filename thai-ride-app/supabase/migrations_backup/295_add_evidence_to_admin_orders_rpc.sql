-- Add pickup_photo, dropoff_photo, arrived_at to get_all_orders_for_admin RPC
-- This allows admin to see evidence photos in the orders view

-- Drop existing function
DROP FUNCTION IF EXISTS public.get_all_orders_for_admin(
  TEXT, TEXT, INTEGER, INTEGER, TEXT, DATE, DATE, TEXT, TEXT
);

-- Create updated function with evidence columns
  ...
  RETURN QUERY EXECUTE format('
    WITH all_orders AS (
      ...
      SELECT 
        ...
        r.estimated_distance::NUMERIC as distance_km,
        ...
        r.pickup_photo::TEXT,
        r.dropoff_photo::TEXT,
        r.arrived_at
      FROM public.ride_requests r
      LEFT JOIN public.users u ON r.user_id = u.id
      LEFT JOIN public.providers_v2 p ON r.provider_id = p.id
      ...
      LEFT JOIN public.providers_v2 p ON d.provider_id = p.id
      ...
      LEFT JOIN public.providers_v2 p ON s.provider_id = p.id
    )
