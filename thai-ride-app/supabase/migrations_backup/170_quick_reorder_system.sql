-- Migration: Quick Reorder System
-- Feature: F254 - Quick Reorder / Repeat Last Order
-- Description: ระบบสั่งซ้ำด้วย 1 คลิก
-- Created: 2024-12-25
...
COMMENT ON TABLE reorder_analytics IS 'F254: Track reorder behavior for analytics';
COMMENT ON FUNCTION quick_reorder_ride IS 'F254: Create new ride from previous order';
COMMENT ON FUNCTION quick_reorder_delivery IS 'F254: Create new delivery from previous order';
COMMENT ON FUNCTION get_reorderable_items IS 'F254: Get list of items that can be reordered';
