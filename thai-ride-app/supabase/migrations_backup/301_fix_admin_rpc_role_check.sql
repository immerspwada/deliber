-- Fix Admin RPC Functions - Use users table instead of profiles
-- ================================================================
-- The admin RPC functions were checking role in 'profiles' table which doesn't exist
-- This migration updates them to check 'users' table instead
...
-- Add comments
COMMENT ON FUNCTION get_admin_providers_v2 IS 'Get provider list with filters and pagination - FIXED to use users table';
COMMENT ON FUNCTION count_admin_providers_v2 IS 'Count providers for pagination - FIXED to use users table';
