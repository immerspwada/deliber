-- ============================================
-- FIX: find_nearby_providers function ambiguity
...
-- Create single unified function with NUMERIC for radius_km
...
-- Verify: should show only 1 function
SELECT proname, proargtypes::regtype[] 
FROM pg_proc 
WHERE proname = 'find_nearby_providers';
