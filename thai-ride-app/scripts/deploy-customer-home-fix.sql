...
-- 3. Create get_reorderable_items function
...
-- 4. Create quick_reorder_ride function
...
-- 5. Create quick_reorder_delivery function
...
-- 7. Verify
SELECT 'get_reorderable_items' as function_name, 
       EXISTS(SELECT 1 FROM pg_proc WHERE proname = 'get_reorderable_items') as exists;
SELECT 'quick_reorder_ride' as function_name,
       EXISTS(SELECT 1 FROM pg_proc WHERE proname = 'quick_reorder_ride') as exists;
SELECT 'quick_reorder_delivery' as function_name,
       EXISTS(SELECT 1 FROM pg_proc WHERE proname = 'quick_reorder_delivery') as exists;

SELECT '✅ Customer Home Fix Deployed Successfully!' as status;
