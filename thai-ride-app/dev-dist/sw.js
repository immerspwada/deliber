...
define(['./workbox-6e3df57f'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/^https:\/\/router\.project-osrm\.org\/.*/i, new workbox.NetworkFirst({
