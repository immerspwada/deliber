...
### 🚨 กฎบังคับ: การแนะนำต้องเป็น Production เท่านั้น (CRITICAL)

**ทุกการแนะนำต้องเหมาะสมกับ Production Environment เท่านั้น**

| ❌ ห้ามแนะนำ                  | ✅ ต้องแนะนำ                |
| ----------------------------- | --------------------------- |
| Demo features หรือ test modes | Production-ready features   |
| Mock integrations             | Real service integrations   |
| Test data seeding             | Safe data migrations        |
| Debug tools ใน UI             | Production monitoring tools |
| Development shortcuts         | Proper error handling       |

**ตัวอย่างการแนะนำที่ถูกต้อง:**

- "แนะนำเพิ่ม Auto-Refund ที่เชื่อมกับ Wallet จริง"
- "แนะนำเพิ่ม Payment Analytics สำหรับ Admin"
- "แนะนำปรับปรุง Error Recovery ให้ robust ขึ้น"

**ตัวอย่างการแนะนำที่ผิด:**

- ~~"แนะนำเพิ่ม Demo Mode"~~
- ~~"แนะนำสร้าง Test Users"~~
- ~~"แนะนำเพิ่ม Debug Panel"~~
